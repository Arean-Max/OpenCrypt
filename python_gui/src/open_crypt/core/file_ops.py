...
# TODO: these four async wrappers are copy-paste; a single
# _run_in_thread(fn, on_done) helper would kill half the lines.
# Left as is for now — works, and I'd rather not churn the GUI code.
