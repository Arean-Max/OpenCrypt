...
Version: 1 (spec revision 2026-08-01)

> **Note:** This spec is still settling. It is written down so the format
> is not a black box, but expect it to change before 1.0 — see the
> "Key derivation" note about KDF parameters for the kind of thing that
> might move.
